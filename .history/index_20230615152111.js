...
app.post("/",(req,res)=>{
  ...
  addDoc(pay,{time:r.created_at,status:r.success,idTrx:r.id,price:r.amount_cents,order:r.order.id,name:r.order.shipping_data.first_name,email:r.order.shipping_data.email,uid:r.order.shipping_data.floor,courseName:r.order.shipping_data.apartment})
