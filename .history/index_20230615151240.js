...
app.post("/",(req,res)=>{
  ...
  addDoc(pay,{time:r.created_at,status:r.success,idTrx:r.id,price:r.amount_cents,order:r.order.id,name:r.order.shopping_data.first_name,email:r.order.shopping_data.email,uid:r.order.shopping_data.floor})
